...
al segnale originale ottenendo l'effetto riverbero. Il tempo di ritardo ottenibile 
varia agendo sia sul numero di celle di memoria coinvolte nel processo, 
sia sulla temporizzazione del trasferimento dei dati da un banco all'altro. 
...
Esistono sul mercato circuiti integrati che comprendono i convertitori A/D e D/A, le memorie ed i circuiti di temporizzazione. 
Con un solo chip è così possibile realizzare un'eco digitale 
in uno spazio ridottissimo e con pochissima componentistica esterna. 
La digitalizzazione del segnale e la sua successiva riconversione in forma analogica causano tuttavia una certa perdita 
di qualità del suono che dipende dalla bontà del campionamento e che non è completamente eliminabile. 
